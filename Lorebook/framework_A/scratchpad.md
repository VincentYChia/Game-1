# Framework A: The Lantern-Year

**Archetype shell:** Sunlit island-league golden age (Archipelago of Eight Tides).
**Filling:** The eight elements are not powers you are born with — they are *Tides*, practiced craft-lineages you apprentice into the way a sailor learns wind or a runner learns stride. Magic is embodied attention, intuitive as catching a ball.
**Tonal register:** Sunlit, salt-aired, craft-proud, festival-rich, generous, unhurried, curious.

---

## 1. Premise & Twist

A league of sunlit islands in a wide warm sea, connected by familiar trade routes and friendly harbors — the kind of world a grandmother in a linen apron describes while pressing a fig into your hand. The twist: magic here is not spellcraft, not birthright, not granted. It is *Tide-practice* — eight elemental traditions apprentices learn the way a violinist learns a concerto, until the body knows fire, or water, or shadow, the way the body knows walking. You don't cast. You *want the hearth to catch*, and because you have tended ten thousand hearths, it catches.
...
**Founding (mythic):** The Tides were *found*, not given. The oldest stories say the first masters were attentive people — a baker, a netmaker, a thatcher, a midwife — who noticed that if they worked with real care, the world answered. They taught openly. The myth, in every telling: *nobody hoarded it.*

**Formative (the Long Codifying):** The League of Eight Harbors was a slow, chatty consolidation — a century of harbormoots, shared charts, agreed measures, traded apprentices. No conquest founded it; it emerged from merchants who wanted *one weight for a bushel.* Remembered as the Green Decades.

**Living memory (the Lantern-Year era):** A good time to be alive, and people know it. Trade is wide, harbors full, the lighthouse-schools open to apprentices from farther than ever before. A new spice arriving. Two festival-musics blending. The old say *we will be remembered like the Green Decades*; the young say *better than that.*
...
**Creatures.** Wildlife: deepwater squid glowing at the dark moon, Sorrun boars, fire-cormorants nesting in chimney-smoke, ice-crabs the Kalmari pay children to catch. Some are large; some bite. None are *evil*. They are part of the living world the way weather is — respected, studied, understood. A seasoned hunter is a naturalist as much as a warrior.

## 6. Institutions

- **The Eight Lighthouse-Schools.** Began when a retired Wave-Tide pilot took apprentices at the light she tended; other masters copied her. Schools now trade students for summers. Lively Ember-Tide debate: should the new Teremethi glass-annealing be taught before or after the classical method? Both camps invite each other to dinner.
- **The Harbormoot.** Grew out of Isoë's quarterly fish-market meetings. Every three years, delegates gather for a twelve-day assembly of weights, measures, lanes, calendars. This year: a new smaller coin for the spice-trade. Arguments long, food excellent.
- **The Open Hand.** An apprentice-exchange fellowship. A master in good standing places an Open Hand stone on their doorway, meaning they will take a season's apprentice from another Tide at no fee. Current question: may a Dawn-Tide physician take a Storm-Tide apprentice purely for shared listening-skills? Elders say yes; the young want to formalize it.
- **The Chart-Hall of the Narrow Shoals.** Begun by a cartographer who would not let her charts be owned privately. A new wing is being built for the deep-shelf surveys; the hall is buzzing.
- **The Festival-Orders.** Loose confederations of musicians, puppeteers, cooks, and pyrotechnicians from the old harvest circuits. Two Orders have just merged for a cross-Tide processional for the Lantern-Year.

**Titles (the ~40).** Earned craft-master epithets and harbor-honorifics — never administrative, always affectionate. Families: *Oven-* (Seventh Oven of Isoë), *Lantern-* (Fourth Lantern of the Narrow Shoals), *Rope-* (Rope-singer of Kalm), *Tide-* (Second Wave of Teremeth), *Voyage-* (She-Who-Found-the-Red-Flower), *Hall-* (Third Hall of the Chart). A handful pass by lineage; most end with the holder. A sailor addressing a Title speaks it the way one greets a friend who has done a specific hard thing well.
...
## Spaces for You to Write Into

- **Room for you to decide what the ninth rumor is** — the Tide no one yet names, whispered by one old sailor on Teremeth, dismissed by serious masters. Possibly a mood, possibly not.
- **Room for you to name the Southern Spice and its people** — what the flower is called in its own tongue, whose kitchens it came from, whether its growers have their own Tides or something else entirely.
- **Room for you to choose a Title for the player's home-master** — the epithet they apprenticed under, the voyage or festival or loaf that earned it.
- **Room for you to decide what lives in the Open Blue** — a deep-sea creature, a weather, a music that drifts in when the wind is right. Wonder, not terror.
- **Room for you to shape the next Teremeth Turn** — what the switch ceremony looks like, what the island is called for the month in between.
