...
def _reset_singletons():
    ...
    from world_system.living_world.ecosystem.ecosystem_agent import EcosystemAgent
...
def test_mock_backend_generate():
    ...
    _reset_singletons()
    from world_system.living_world.backends.backend_manager import MockBackend
...
def test_backend_manager_singleton():
    ...
    _reset_singletons()
    from world_system.living_world.backends.backend_manager import BackendManager, get_backend_manager
...
def test_npc_memory_basic():
    ...
    _reset_singletons()
    from world_system.living_world.npc.npc_memory import NPCMemory
...
def test_faction_serialization():
    ...
    _reset_singletons()
    from world_system.living_world.factions.faction_system import FactionSystem as FS2
...
def test_ecosystem_serialization():
    ...
    # Restore
    _reset_singletons()
    from world_system.living_world.ecosystem.ecosystem_agent import EcosystemAgent as EA2
